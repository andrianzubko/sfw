...
{
    /**
     * Any public method of any class can be a controller.
     */
    #[\SFW\AsController('/')]
    public function index(): void
    {
         ...
         */
        self::sys('Response')->template('regular.index.html', ['phrase' => $this->phrase]);
    }

    /**
     * More complex example.
     *
     * Of course, it's better to use models for all of this.
     *
     * Don't need to worry about exceptions. They all will be correctly caught.
     */
    #[\SFW\AsController('/test/{id}', 'get', 'some_alias')]
    public function test(): void
    {
        ...
        self::sys('Transaction')->run(
            function (): bool {
                 ...
                 *
                 * You can explicitly call self::sys('Db')->commit() before response if needed.
                 */
                if (0) {
                    self::sys('Response')->json(['error' => 'Wrong id!']);
                }

                /* That's mean commit.
                 */
                return true;
            } //, 'ISOLATION LEVEL REPEATABLE READ', ['40001','40P01','23505']
        );

        /* Url can be generated by alias, full or short method name.
         *
         ...
         *
         * To prevent exit after response use exit(false) method.
         */
        self::sys('Response')->exit(false)->template('regular.index.html', $this);
